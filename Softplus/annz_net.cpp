...
int main()
{
  ...
  string arch = ss.str(); // Edit (Aug 2020): added this line, declare string first, then declare character.
  const char * archi = arch.c_str();

  //---------------------------------------------
  // Write architecture to file.
  //---------------------------------------------
  
  ofstream arch_file(archi);
  
  arch_file << "# Generated by annz_net" << endl;
  arch_file << "# " << archi << endl;
